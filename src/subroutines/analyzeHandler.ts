            ...
            if(extension === ".cpp"){
                ...
                try{
                    ...
                    if(compileError){
                        ...
                        let instructionCommand = `${APPPATH} analyze --profile ${profilepath} --mode instruction --format json --strategy worst --loopbound 100 --withCalls --program ${TMPDIR}/compiled/${filename}.ll`;
