 ...
 */
export default async function generateGraph() {
            ...
            if(extension === ".cpp"){
                ...
                try{
                    ...
                    if(compileError){
                        ...
                        const { graphgenerationError } = await exec(`${APPPATH} analyze --profile ${profilepath} --mode graph --format json --strategy worst --loopbound 100 --withCalls --program ${TMPDIR}/compiled/${filename}.ll > ${TMPDIR}/graph.dot`);
                    ...
                    console.error(e);
                    vscode.window.showErrorMessage("The generation of the graph failed!");
                }
            }else{
